...
using System.Net;
using Syncfusion.Server.ApiClient.Utilities;
using Syncfusion.Server.ApiClient.Authentication;
using System.Runtime.Serialization.Formatters.Binary;
using System.IO;

namespace Syncfusion.Server.ApiClient
{
    public class ServerApiClient
    {
        ...
        internal DataResponse<T> Put<T>(T body, string overrideUrl)
        {
            return Send(body, Method.PUT, overrideUrl);
        }

        internal DataResponse<T> Delete<T>(T body, string overrideUrl)
        {
