...
namespace Syncfusion.Server.ApiClient.V1.EndPoints
{
    public class GroupsEndPoint
    {
        ...
        public DataResponse<Groups> GetAllGroups()
        {
            ...
            return _serverClientV1.Get(groups, _baseUrl);
        }
        ...
        public DataResponse<Group> GetGroup(int groupId)
        {
            var requestUrl = _baseUrl + "/" + groupId;
            return _serverClientV1.Get(new Group(), requestUrl);
        }
        ...
        public DataResponse<Users> GetGroupMembers(int id)
        {
            var requestUrl = _baseUrl + "/" + id + "/users";
            return _serverClientV1.Get(new Users(), requestUrl);
        }
